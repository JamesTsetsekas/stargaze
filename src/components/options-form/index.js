      ...
      <div className="options-form">
        <div className="form-field">
          ...
          <ul>
            <li>
              Go to the
              <a href="https://github.com/settings/tokens/new?description=StarGaze&scopes=public_repo" target="_blank" rel="noopener noreferrer"><i className="fa fa-external-link mr-1"></i>Settings <i className="fa fa-angle-right"></i> Personal Access Tokens <i className="fa fa-angle-right"></i> New personal access token</a> of your github profile
            </li>
